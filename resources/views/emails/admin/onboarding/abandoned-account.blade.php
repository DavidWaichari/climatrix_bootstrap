@extends('emails.new-master')
    ...
    <div style="padding:0.5%">
        <div style="width: 100%; text-align: center; margin-top: 4rem;">
            ...
            <div>
                <p style="font-family:Montserrat; font-size:25px; font-style:normal; font-weight:300; line-height:normal; text-align:center" align="center"><span style="color:#5063F4; font-family:Montserrat; font-size:24px; font-style:normal; font-weight:700; line-height:normal"> {{ $business_stage["business_name"]}} abandoned registration at {{ $business_stage["stage"]}}. </span> <br>Kindly review
