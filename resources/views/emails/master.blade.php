                        ...
                        <table style="width: 100%;border-collapse: collapse;">
                            ...
                            <tr>
                                <td style="vertical-align: middle;height: 70px;">
                                    <h2 style="color: white">Climatric</h2>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="row col-sm-12 col-md-12 col-lg-12 col-12" id="body-box">
                        <div class="col-sm-12 col-md-12 col-lg-12 col-12" style="width: 100%;background: white;">
                                ...
                                <div id="buttons-div">
                                    ...
                                    <a href="{{url('/climatrix-admin/login')}}" class="btn btn-outline-info btn-lg" id="button2">Login</a>
                                    @endif
                                ...
                                <div class="row col-sm-12 col-md-12 col-lg-12 col-12" id="header-box">
                                    <table style="width: 100%;border-collapse: collapse;">
                                        <tbody>
                                            <tr>
                                                <td style="vertical-align: middle;height: 70px;">
{{--                                                    <img src="{{ url('/assets/images/logo_dark.png') }}" height="25" style="height: 25px"  alt="Climatrix Logo"/>--}}
                                                    <h2 style="color: white">Climatrix</h2>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;text-align: center;width: 10%">
                                                    <a class="btn btn-link" href="" style="color: #444"><img src="{{ url('/assets/images/icons/linkedin-brands.png') }}" alt="LinkedIn" height="20" style="height: 20px"/></a>
                                                </td>
                                                <td style="vertical-align: middle;text-align: left;width: 45%">
                                                    <a class="btn btn-link" href="mailto:info@climatric.ca" style="color: #444"><img src=" {{ url('/assets/images/icons/envelope-solid.png') }}" alt="Email" height="20" style="height: 20px"/></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div id="disclaimer-div">
                                    Not sure why you received this email?<br> <a href="mailto:info@climatrix.ca"><b>Email</b></a> us or use our <a href="{{ url('/') }}"><b>Chat</b></a>.<br/><br/>
                                    <span>&copy; {{ date('Y') }} <a target="_blank" href="{{ url('/') }}"><b>Climatrix Inc</b></a></span>
                                </div>
