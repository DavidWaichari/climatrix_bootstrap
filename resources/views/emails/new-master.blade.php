...
<body>
    ...
    <div class="container my-4"
        ...
        <div class="w-100 d-flex justify-content-center"
            ...
            <img src="{{ asset('assets/emails/climatric/Logo.pngg') }}" alt="" class="mx-auto d-block"
        ...
        <div class="footer" style="box-sizing: border-box;">
            <div style="width: 100%; display: table; margin: 0 auto;">
                <div class="cta-icons"
                    ...
                    <a href="mailto:info@climatric.ca" target="_blank"
            ...
            <div style="width: 100%; display: table; margin: 0 auto;">
                <p
                    ...
                    <span
                        ...
                        <a class="links" href="mailto:info@climatric.ca"
