...
.bh-pagination-number .bh-page-item.bh-active {
    background-color: #45a049 !important; /* Set your desired background color for the active button */
    color: #fff; /* Set text color */
    font-weight: bold; /* Optional: Make the text bold */
}

/* Style for disabled button */
.bh-pagination-number .bh-page-item.disabled {
    background-color: #ccc; /* Set background color for disabled button */
...
.bh-pagination .bh-page-item:hover {
    background-color: #388E3C !important; /* Set hover background color */
